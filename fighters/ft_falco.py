...
falco.subactions[0x127].friendly_name = "Blaster"
falco.subactions[0x128].friendly_name = "Blaster"
falco.subactions[0x129].friendly_name = "Blaster"
falco.subactions[0x12A].friendly_name = "Blaster"
falco.subactions[0x12B].friendly_name = "Blaster"
falco.subactions[0x12C].friendly_name = "Blaster"
falco.subactions[0x12D].friendly_name = "Phantasm"
falco.subactions[0x12E].friendly_name = "Phantasm"
falco.subactions[0x12F].friendly_name = "Phantasm"
falco.subactions[0x130].friendly_name = "Phantasm"
falco.subactions[0x131].friendly_name = "Phantasm"
falco.subactions[0x132].friendly_name = "Phantasm"
falco.subactions[0x133].friendly_name = "Fire Bird"
falco.subactions[0x134].friendly_name = "Fire Bird"
falco.subactions[0x135].friendly_name = "Fire Bird"
falco.subactions[0x136].friendly_name = "Fire Bird"
falco.subactions[0x137].friendly_name = "Fire Bird"
falco.subactions[0x138].friendly_name = "Fire Bird"
falco.subactions[0x139].friendly_name = "Reflector"
falco.subactions[0x13A].friendly_name = "Reflector"
falco.subactions[0x13B].friendly_name = "Reflector"
falco.subactions[0x13C].friendly_name = "Reflector"
falco.subactions[0x13D].friendly_name = "Reflector"
falco.subactions[0x13E].friendly_name = "Reflector"
falco.subactions[0x13F].friendly_name = "Reflector"
falco.subactions[0x140].friendly_name = "Reflector"
falco.subactions[0x141].friendly_name = "Taunt"
falco.subactions[0x142].friendly_name = "Taunt"
falco.subactions[0x143].friendly_name = "Taunt"
falco.subactions[0x144].friendly_name = "Taunt"
falco.subactions[0x145].friendly_name = "Taunt"
falco.subactions[0x146].friendly_name = "Taunt"

for action in falco.subactions:
...
falco.get_attribute("Reflector Gravity Frame Delay").integer = True
